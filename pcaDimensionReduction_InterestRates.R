#####################################################################################################################################
# https://cunef.instructure.com/courses/2203/assignments/13829
# El objetivo que perseguimos en el presente trabajo es, simplemente, efectuar una comprobación empírica
# mediante la aplicación del ACP a un conjunto de 978 observaciones de los rendimientos de 10 bonos norteamericanos
# a distintos plazos entre el 2 de enero de 1995 y el 30 de septiembre de 1998. No pretendemos nada más que verificar si,
# tal y como plantean los estudios teóricos, puede establecerse una estructura subyecente que sintetice y agrupe los distintos
# plazos en virtud de sus características comunes. Para ello, deberá trabajar con el archivo ACPTIUSD.csv Vista previa del documento,
# disponible en la plataforma, del que deberá utilizar las 949 primeras observaciones (denominadas observaciones activas) y las 9 
# primeras variables (las variables activas); uno de los objetivos será emplear las observaciones 950 a 978 (llamadas observaciones 
# suplementarias) para predecir el valor del bono a 10 años (IRS.10Y, variable suplementaria). Aparte de cubrir este objetivo,
# queremos asimismo tener respuesta a las siguientes preguntas:
#####################################################################################################################################
...
# OBJETIVO 2: Responder preguntas 1.2.3
# A EXTRAER:
# Puede establecerse una estructura subyecente que sintetice y agrupe los distintos plazos en virtud de sus características comunes?
# USAR:
#   OBSERVACIONES: 949 primeras observaciones (denominadas observaciones ACTIVAS) --> active_data
#   VARIABLES: 9  primeras variables (las variables activas)
